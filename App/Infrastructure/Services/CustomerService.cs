...
public class CustomerService : ICustomerService
{
    ...
    public CustomerService(ICustomerValidator customerValidator, ICompanyRepository companyRepository,
        ICreditLimitFactory creditLimitFactory, ICustomerDataAccessWrapper customerDataAccessWrapper)
    {
    ...
    public async Task<bool> AddCustomer(string firstname, string surname, string email, DateTime dateOfBirth,
        int companyId)
    {
